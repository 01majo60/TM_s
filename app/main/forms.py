...
class MyForm(FlaskForm):
    ...
    left_end = StringField("Lavá koncová značka defaultne: '>' ak necháte políčko prázdne ", validators=[])
...
class TmachineForm(FlaskForm):
    opts = QuerySelectField(query_factory=tmachine_query, allow_blank=False, get_label='definicia')
